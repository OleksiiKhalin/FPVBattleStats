...
export type GlobalLeaderboardForecast = {
  ...
  no_flight_adjusted_average_gap_percentage: number | null;
  continue_adjusted_average_gap_percentage: number | null;
...
export type GlobalLeaderboardRow = {
  ...
  days_needed_for_next_season: number;
  available_days_before_next_season: number;
  next_season_retained_days: number;
  can_pass_next_season: boolean;
  season_start_rank: number | null;
  season_start_league: string | null;
  season_start_snapshot_date: string | null;
  projected_next_season_rank: number | null;
  projected_next_season_league: string | null;
  projected_next_season_eligible: boolean;
  smart_sort_bucket: number;
